...
export class MainpageComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.data = [{id:"1",text:"important mission1",list:"a good list",board:"bisli",labels:["general"],date:"2019-09-02T09:30",userid:"2"},
                     {id:"2",text:"important mission2",list:"better list",board:"bisli2",labels:["general","meme"],date:"2019-09-02T15:20",userid:"2"},
